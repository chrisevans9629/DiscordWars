...
export class Level2 extends LevelBase implements ILevel {
    ...
    createBases(){
        ...
        let baseSetup = [
            {id: 1,team:-1,xCell: 1, yCell: 1,maxLvl: 3},
            {id: 2,team: 1,xCell: 1, yCell: 2,maxLvl: 3},
            {id: 3,team:-1,xCell: 1, yCell: 3,maxLvl: 3},
            {id: 4,team:-1,xCell: 2, yCell: 2,maxLvl: 3},
            {id: 5,team:-1,xCell: 3, yCell: 1,maxLvl: 3},
            {id: 6,team: 2,xCell: 3, yCell: 2,maxLvl: 3},
            {id: 7,team:-1,xCell: 3, yCell: 3,maxLvl: 3},
        ];
